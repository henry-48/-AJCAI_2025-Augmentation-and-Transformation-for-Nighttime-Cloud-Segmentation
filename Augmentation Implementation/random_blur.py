...
def apply_random_glow_to_folder(input_folder, output_folder):
...
register(
    "python_fu_apply_random_glow_to_folder",
    "Apply random glow effect to all images in a folder",
    "Loads each image in the specified folder, applies a random glow effect, and saves the result in the output folder",
    "Name", "Name", "2024",
    "<Toolbox>/Xtns/Languages/Python-Fu/Apply Random Glow to Folder",
    "",
    [
